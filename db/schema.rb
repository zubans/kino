...
ActiveRecord::Schema.define(version: 2021_04_09_075629) do
...
#   Unknown type 'enum' for column 'status'
  ...
  create_table "seanses", force: :cascade do |t|
    t.datetime "seans_time"
    t.integer "film_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["film_id"], name: "index_seanses_on_film_id"
  end

# Could not dump table "tickets" because of following StandardError
#   Unknown type 'enum' for column 'ticket_type'
